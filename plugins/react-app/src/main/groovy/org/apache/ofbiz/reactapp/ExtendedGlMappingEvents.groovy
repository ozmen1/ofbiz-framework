...
final String MODULE = "ExtendedGlMappingEvents.groovy"
 ...
 */
String getVarianceReasonGlAccounts() {
 ...
 */
String createVarianceReasonGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
 ...
 */
String deleteVarianceReasonGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String getCreditCardTypeGlAccounts() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    try {
        List<GenericValue> list = EntityQuery.use(delegator)
 ...
 */
String createCreditCardTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String deleteCreditCardTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String getFixedAssetTypeGlAccounts() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    try {
        List<GenericValue> list = EntityQuery.use(delegator)
 ...
 */
String createFixedAssetTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String deleteFixedAssetTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String getFinAccountTypeGlAccounts() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    try {
        List<GenericValue> list = EntityQuery.use(delegator)
 ...
 */
String createFinAccountTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String deleteFinAccountTypeGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def dispatcher = binding.getVariable("dispatcher") ?: request.getAttribute("dispatcher")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String getProductCategoryGlAccounts() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    try {
        List<GenericValue> list = EntityQuery.use(delegator)
 ...
 */
String createProductCategoryGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
 ...
 */
String deleteProductCategoryGlAccount() {
    def delegator = binding.getVariable("delegator") ?: request.getAttribute("delegator")
    def request = binding.getVariable("request")
    def parameters = binding.getVariable("parameters") ?: request.getParameterMap()
